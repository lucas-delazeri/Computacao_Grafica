  ...
  if (glfwGetKey(window, GLFW_KEY_E) == GLFW_PRESS) {
    ...
    if ((glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS)) {
      if ((scale_x > -kScaleLimit)) {
        ...
        hud_text << "Escalando para esquerda " << std::endl;
      }
    }
    if ((glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS)) {
      if ((scale_x < kScaleLimit)) {
        ...
        hud_text << "Escalando para direita " << std::endl;
      }
    }
    if ((glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS)) {
      if ((scale_y > -kScaleLimit)) {
        ...
        hud_text << "Escalando para baixo " << std::endl;
      }
    }
    if ((glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS)) {
      if ((scale_y < kScaleLimit)) {
        ...
        hud_text << "Escalando para cima " << std::endl;
      }
    }
    if ((glfwGetKey(window, GLFW_KEY_PAGE_DOWN) == GLFW_PRESS)) {
      if ((scale_z > -kScaleLimit)) {
        ...
        hud_text << "Escalando para frente " << std::endl;
      }
    }
    if ((glfwGetKey(window, GLFW_KEY_PAGE_UP) == GLFW_PRESS)) {
      if ((scale_z < kScaleLimit)) {
        ...
        hud_text << "Escalando para trás " << std::endl;
      }
    }
  }
